...
public class PruebasController {
    ...
    public String consultaQueryTarea(@RequestParam(value = "existenciasInf") int existenciasInf,
            @RequestParam(value = "existenciasSup") int existenciasSup, Model model) {
        var productos = productoService.metodoNativoExistenciasTarea(existenciasInf, existenciasSup);
        model.addAttribute("productos", productos);        
        model.addAttribute("totalProductos", productos.size());
